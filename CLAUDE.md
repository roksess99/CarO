...
| Meest gezocht | `lib/catalog/quick-links.ts`, `components/catalog/group-list.tsx` | Rij met de tien gangbare onderhoudsdelen boven het categorierooster, met het aantal artikelen voor die auto. Het zijn **eindgroepen**, dus één klik naar de artikelen. De node-ids zijn op drie auto's gemeten en identiek; of de groep bestáát verschilt wel — niet elke auto heeft een distributieriem. Kost geen extra boom-call: zelfde gecachte `/category` als het rooster, en beide tellen in één batch |
...
# De dagelijkse prijsmeting los aanroepen (cron-taak bij de hostingpartij):
